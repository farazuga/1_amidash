...
import { fetchRevenueData } from './revenue';
// Mock logger
...
describe('fetchRevenueData', () => {
    ...
    describe('when Supabase is not configured', () => {
        ...
        it('should log debug message about mock data', async () => {
            ...
            expect(logger.debug).toHaveBeenCalledWith('Supabase not configured, returning mock revenue');
        });
    ...
    describe('when Supabase is configured', () => {
        ...
        it('should return mock data on error', async () => {
            ...
            const revenue = await fetchRevenueData();
            expect(logger.error).toHaveBeenCalledWith({ error: expect.any(Object) }, 'Failed to fetch revenue data, returning mock data');
        ...
        it('should filter by current year', async () => {
            ...
            expect(mockHistoryQuery.gte).toHaveBeenCalledWith('changed_at', `${currentYear}-01-01`);
        });
    });
...
//# sourceMappingURL=revenue.test.js.map