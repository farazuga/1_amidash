...
import { SlideTypeSchema, SlideConfigSchema, NDIConfigSchema, DisplayConfigSchema, PollingConfigSchema, TransitionConfigSchema, APIConfigSchema, SignageConfigSchema, validateConfig, } from './schema';
describe('Config Schema', () => {
    ...
    describe('SlideConfigSchema', () => {
        ...
        it('should reject duration below minimum', () => {
            expect(() => SlideConfigSchema.parse({
                type: 'active-projects',
                duration: 500,
            })).toThrow();
        });
    ...
    describe('SignageConfigSchema', () => {
        ...
        it('should require at least one slide', () => {
            expect(() => SignageConfigSchema.parse({
                slides: [],
            })).toThrow();
        });
    });
