...
export class BottleneckAlertSlide extends BaseSlide {
    ...
    drawHealthyState(ctx, headerHeight) {
        const centerX = this.displayConfig.width / 2;
        const centerY = (this.displayConfig.height + headerHeight) / 2;
    ...
    drawBottleneckDashboard(ctx, bottlenecks, headerHeight, totalProjects) {
        const padding = 80;
    ...
    drawSummaryBar(ctx, bottlenecks, x, y, width, height, totalProjects) {
        ...
        drawProgressBar(ctx, bottleneckPercent, 100, barX, y + height / 2 - 12, barWidth, 24, {
            fillColor: severity,
    ...
    drawBottleneckCard(ctx, bottleneck, x, y, width, height) {
...
//# sourceMappingURL=bottleneck-alert.js.map