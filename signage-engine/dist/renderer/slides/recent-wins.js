...
export class RecentWinsSlide extends BaseSlide {
    ...
    drawWinsDashboard(ctx, wins, metrics, headerHeight) {
        const padding = 80;
    ...
    drawSummarySection(ctx, wins, metrics, x, y, width, height) {
    ...
    drawWinsGrid(ctx, wins, x, y, width, height) {
    ...
    drawWinCard(ctx, win, x, y, width, height, index) {
...
//# sourceMappingURL=recent-wins.js.map