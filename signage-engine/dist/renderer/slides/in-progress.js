...
export class InProgressSlide extends BaseSlide {
    ...
    drawProjectList(ctx, projects, headerHeight) {
        const padding = 80;
        const gap = 24;
    ...
    drawProjectRow(ctx, project, x, y, width, height, index) {
        ...
        drawProgressBar(ctx, progressPercent, 100, progressX, y + height / 2 - 5, progressWidth, 20, {
