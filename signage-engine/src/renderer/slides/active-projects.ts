...
export class ActiveProjectsSlide extends BaseSlide {
  ...
  private drawProjectCard(
    ...
    drawText(
      ctx,
      truncateText(ctx, project.name, width - padding * 2 - 20, this.displayConfig.fontFamily, 72),
      x + padding + 16,
      y + padding + 130,
      {
        font: this.displayConfig.fontFamily,
    ...
    drawText(
      ctx,
      truncateText(ctx, project.client_name, width * 0.55, this.displayConfig.fontFamily, 48),
      x + padding + 16,
      y + padding + 200,
      {
        font: this.displayConfig.fontFamily,
