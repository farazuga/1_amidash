...
export class POTickerSlide extends BaseSlide {
  ...
  private drawSmallPOCard(
    ...
    drawText(
      ctx,
      truncateText(ctx, po.project_name, width * 0.50, this.displayConfig.fontFamily, 28),
      x + cardPadding + 8,
      y + cardPadding + 52,
      {
        font: this.displayConfig.fontFamily,
    ...
    drawText(
      ctx,
      truncateText(ctx, po.client_name, width * 0.40, this.displayConfig.fontFamily, 22),
      x + cardPadding + 8,
      y + cardPadding + 82,
      {
        font: this.displayConfig.fontFamily,
